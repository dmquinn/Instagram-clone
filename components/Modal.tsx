...
import { filterState } from "../atoms/filtersAtom";
            ...
            <div className="flex">
              <>
                <div
                  className={
                    filtersOpen
                      ? "first relative bg-plain-white opacity-100 rounded-lg w-screen md:max-w-lg mx-auto mt-[90px] h-[600px] shadow-lg"
                      : "first relative bg-plain-white opacity-100 rounded-lg w-screen md:max-w-2xl mx-auto mt-[90px] h-[600px] shadow-lg"
                  }
                >
                  <div className="p- justify-center content-center h-full items-center">
                    {" "}
                    ...
                    {imageSrc ? (
                      ...
                      <img
                        src={croppedImage}
                        className={`${mainFilter} min-h-full min-w-full`}
                        alt="cropped"
                      />
                    ) : (
